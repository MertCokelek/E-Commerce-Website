...
public class BookController {
	...
	public String saveOrUpdateBook(@Valid BookForm bookForm, BindingResult bindingResult,
		...
		/*
		 * Book bookFetched = bookService.getById(bookForm.getId()); Long
		 * id_of_prev_book = bookForm.getId(); if (bookFetched != null) { // Edit
		 * bookService.delete(bookForm.getId()); } bookForm.setId(id_of_prev_book);
		 */

		Book savedBook = bookService.saveOrUpdate(bookService.saveOrUpdateBookForm(bookForm));
